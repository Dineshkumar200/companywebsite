...
<head>
    <title>Dinesh Electronic Private Limited
    </div></title>
...
<body>
    <div class="container">
    <div class="banner">
        Dinesh Electronic Private Limited.
    </div>
    <div class="menu">
    ...
    <div class="footer">
        Copyright © 2020 Dinesh Electronic Private Limited, Developed by Dineshkumar V.
    </div>
    </div>
</body>
...
{% block content %}
    <div class="homecont">    
    <h1>Contact Us</h1>
    <img src="/static/img/contact.jpg" alt="Building">
    <div class="contenttext">
    <p style="font-size:30px">email : dineshelectroniclimited@gmail.com</p>
...
![output](./static/img/check1.jpg)

![output](./static/img/check2.jpg)

![output](./static/img/check3.jpg)

![output](./static/img/check4.jpg)

![output](./static/img/check5.jpg)
## RESULT:
Thus a website is designed for the chip manufacturing company and is hosted in the URL http://dineshkumar.student.saveetha.in:8000/ HTML code is validated.